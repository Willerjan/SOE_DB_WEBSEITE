...
<body class="impressum">
    ...
    <div class="imp ">
        ...
        <div class="text datenschutz">
            ...
            <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Gulan Beking<br />
    ...
    <div class="footer">
        <div class="header_nav">
            ...
            <div class="menu_nav">
                <ul>
                    <a href="Datenschutz.php"><li class="acitve">Datenschutz</li></a>
